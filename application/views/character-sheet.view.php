...
if(!class_exists('Character_Sheet_View')) {
    ...
    class Character_Sheet_view extends Base_View {
        ...
        public function buildGrapple($grapple) {
            ...
            $html .= '<input id="grapple_total" name="grapple_total" type="number" value="' . $grapple->getGrappleTotal() . '">' . "\n";
            $html .= '<label for="grapple_bab">Base Attack Bonus: </label>';
            $html .= '<input id="grapple_bab" name="grapple_bab" type="number" value="' . $grapple->getGrappleBab() . '">' . "\n";
            $html .= '<label for="grapple_str_mod">Strength Modifier: </label>';
            $html .= '<input id="grapple_str_mod" name="grapple_str_mod" type="number" value="' . $grapple->getGrappleStrMod() . '">' . "\n";
            $html .= '<label for="grapple_size_mod">Size Modifier: </label>';
            $html .= '<input id="grapple_size_mod" name="grapple_size_mod" type="number" value="' . $grapple->getGrappleSizeMod() . '">' . "\n";
            $html .= '<label for="grapple_misc_mod">Misc Modifier: </label>';
            $html .= '<input id="grapple_misc_mod" name="grapple_misc_mod" type="number" value="' . $grapple->getGrappleMiscMod() . '">' . "\n";
        ...
        public function buildAttack(Attack $attack) {
            ...
            $html .= '<input name="attack_name" type="text" maxlength="50" value="' . $attack->getName() . '">' . "\n";
            $html .= '<label>Attack Bonus: </label>';
            $html .= '<input name="attack_base_attack_bonus" type="text" value="' . $attack->getAttackBonus() .'">' . "\n";
            $html .= '<label for="attack_damage">Damage: </label>';
            $html .= '<input name="attack_damage" type="text" maxlength="20" value="' . $attack->getDamage() .'">' . "\n";
            $html .= '<label for="attack_critical_floor">Critical: </label>';
            $html .= '<input name="attack_critical_floor" type="number" value="' . $attack->getCriticalFloor() .'">' . "\n";
            $html .= '<input name="attack_critical_ceiling" type="number" value="' . $attack->getCriticalCeiling() .'">' . "\n";
            $html .= '<label for="attack_weapon_range">Range: </label>';
            $html .= '<input name="attack_weapon_range" type="number" value="' . $attack->getWeaponRange() .'">' . "\n";
            $html .= '<label for="attack_type">Type: </label>';
            $html .= '<input name="attack_type" type="text" value="' . $attack->getType() .'">' . "\n";
            $html .= '<label for="attack_notes">Notes: </label>';
            $html .= '<input name="attack_notes" notes="text" value="' . $attack->getNotes() .'">' . "\n";
            $html .= '<label for="attack_ammunition">Ammunition: </label>';
            $html .= '<input name="attack_ammunition" ammunition="text" value="' . $attack->getAmmunition() .'">' . "\n";
